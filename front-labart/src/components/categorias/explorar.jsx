              ...
              <div className="contenedor_tarjetas_categorias">
                <div className="row">
                  ...
                  <div
                    ...
                    onClick={() => navigate('/publicaciones-recomendadas')}
                    style={{ cursor: "pointer" }}
                  >
                    <img
                      className="imagenes_categorias"
                      src="https://cdn-icons-png.flaticon.com/512/1077/1077035.png" // Puedes cambiar este ícono por algo más relacionado
                      alt="Recomendados"
                    />
                    <div className="contenedor_tittle_categoria_fila">
                      <h3 className="titulo_categorias">Recomendados para ti</h3>
                    </div>
                  </div>
