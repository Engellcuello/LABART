export function mostrar(ID_publicacion) {
...
export function mostrar_mis_saves() {
...
export function mostrar_publicar_categoria() {
...
export function nomostrar_publicar_categoria() {
...
export function nomostrar_ajustes_lenguaje() {
...
export function verificarYOcultar_detalles() {
...
export function verificarYOcultar() {
    const fondoBorroso = document.getElementById('fondo_borroso');
    if (fondoBorroso.style.display === 'block') {
...
export function verificarYOcultar_editar() {
    const fondoBorroso = document.getElementById('fondo_borroso');
    if (fondoBorroso.style.display === 'block') {
...
export function nomostrar_ajustes() {
    document.getElementById('contenedor_ajustes').style.display = 'none';
    document.getElementById('home').style.overflowY = 'visible';

}

export function mostrar_ajustes() {
...
export function abrir_guardados() {
